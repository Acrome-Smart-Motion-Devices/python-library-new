...
class Green(SMD_Device):
	...
	def set_microstepping(self, microstepping:int, auto_stepping_enable:bool = True, auto_stepping_interpolation:int= autoStepInterpolation._256_Interpolation):
		...
		self.set_variables([Index_Green.Microstepping, microstepping], [Index_Green.AutoStepInterpolation_enable, auto_stepping_enable], [Index_Green.AutoStepInterpolation_setting, auto_stepping_interpolation])
		self._post_sleep()
